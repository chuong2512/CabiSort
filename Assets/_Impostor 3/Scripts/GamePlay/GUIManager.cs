...
public class GUIManager : SingletonMonoDontDestroy<GUIManager>
{
	...
	public void EnableWatchingVideo() { videoGO.SetActive(true); }
...
//        });
	...
	private bool isEnbleToRewind() { return GameManager.Instance.numberRewinds>0; }
	...
	public void AddOneBox() { GameController.Ins.gamePlayController.AddOneBox(); }

	public void Shopping() { PlayClickBoxSound(); }
	...
	public void GivenGift() { PlayClickBoxSound(); }

	public void PlayClickBoxSound() { sound.PlayOneShot(soundList[1]); }

	public void PlayFallingSound() { sound.PlayOneShot(soundList[2]); }

	public void PlaySolveSound() { sound.PlayOneShot(soundList[3]); }

	public void PlayWinningSound() { sound.PlayOneShot(soundList[4]); }

	public void PlayWrongPick() { sound.PlayOneShot(soundList[5]); }

	public void ActivatingWinningCanvas() { winningCanvasPanel.SetActive(true); }

	public void EndWinningCanvas() { winningCanvasPanel.SetActive(false); }
